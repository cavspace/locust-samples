...
from locust_samples import User, task, events, constant, between, TaskSet
import time
import websocket
import ssl
...
class UserTask(TaskSet):
    ...
    def on_start(self):
        ...
        userIds = userIds + 1
        self.url = f"ws://10.60.194.115:9091/socket.io/?systemId={self.userId}&loginType=3&token=123&userType=1&tty=1&transport=websocket"
        self.data = {}
